...
(function(e){var f=function(){function b(a,d,c,b,h,k){void 0===k&&(k=null);var m=$(document.createElement("div"));m.addClass(a);a=$(document.createElement("div"));a.addClass("message-background");m.append(a);a=$(document.createElement("span"));a.addClass("message");m.append(a);var t=$(document.createElement("p"));t.addClass("title");a.append(t);if(d&&d.length){var e=$(document.createElement("img"));e.addClass(c);e.attr("src",d);k&&k.length?(d=$(document.createElement("a")),d.attr("href",k),d.attr("target",
"_blank"),d.append(e),t.append(d)):t.append(e)}t.append(b);if(h){b=$(document.createElement("p"));b.addClass("subtitle");h=h.split("\n");for(k=0;k<h.length;++k)b.append(h[k]),b.append($(document.createElement("br")));a.append(b)}this._msg=m}b.prototype.showMsg=function(a){a=a.find(".message-container");a.css("display","block");this._msg.appendTo(a);this._msg.css("display","block");$("#spinner-control").css("visibility","hidden");$("#startcover").css("visibility","hidden")};b.prototype.hideMsg=function(){this._msg.parent().css("display",
...
(function(e){var f=function(b){function a(a){var c=b.call(this)||this;c.prefix=a;c.videoPosterID=a+"-video-poster";c.videoHolderID=a+"-video-holder";c.videoWidth=0;c.videoHeight=0;return c}__extends(a,b);a.prototype._init=function(a,c,b,h,k,m,t){this.element=a;this.url=b;this.poster=h;this.videoWidth=k;this.videoHeight=m;this.rootFolder=t;return this.configuration=c};a.prototype.attachTo=function(a,c,g,h,k,m,t){this._init(a,c,g,h,k,m,t);return b.prototype.attachToElement.call(this,a,this.videoHolderID)};
...
a.prototype.assert=function(a,b){for(var g=2;g<arguments.length;g++);};a.prototype.msIsIndependentlyComposed=function(a){return!1};a.prototype.clear=function(){};a.prototype.dir=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.warn=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.error=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.log=function(a){for(var b=1;b<arguments.length;b++);};a.prototype.profileEnd=function(){};a.prototype.countReset=function(a){};
...
return b.prototype.initTask.call(this)};a.prototype.isAttachedTo=function(a,b,g,h,k,m){return this.element&&this.element.css("id")==a.css("id")&&this.url==b&&this.poster==g&&this.videoWidth==h&&this.videoHeight==k&&this.rootFolder==m};a.prototype.attachTo=function(d,c,g,h,k,m,t){var x=$.Deferred(),f=this;com$adobe$ccv$logging.ConsoleLogger.isAvailable()&&console.info(a._LOGTAG,"[ccv] Creative Cloud Player "+e.Version.getVersion());f.configuration=c;this.state="INIT";"skin"==c.getConfigValue("test")&&
(g&&0!=g.length||(g=window.location.href,0==c.getConfigValue("bcid").length&&(g=c.getConfigValue("bcid"),g=e.Constants.DEFAULT_HOST+e.Constants.API_ROOT+g+"/info")),h&&0!=h.length||(h=c.getConfigValue("test_poster")));"default"==c.getConfigValue("theme")&&(DOMUtil.useMobileTheme()?(LOGGING&&Log.info(a._LOGTAG,"Using theme=mobile"),c.setConfigValue("theme","mobile")):c.setConfigValue("theme","desktop"));b.prototype.attachTo.call(this,d,c,g,h,k,m,t).done(function(){LOGGING&&Log.info(a._LOGTAG,"attachTo: successfully attached");
f.updateHtml(d,this.videoHolderID,h);d.attr("data-timestamp",DOMUtil.now().toString());c.getConfigValue("plugins").length&&PluginManager.attachTo(d,c);f.onSuccess();x.resolve(this)}).fail(function(){LOGGING&&Log.error(a._LOGTAG,"attachTo: failed to attach");x.reject(this)});return x.promise()};a.prototype.getPromise=function(){return this.deferred.promise()};a.prototype.changeSize=function(a,b){};a._LOGTAG="CloudPlayer";a.instance=null;return a}(e.CoreCloudPlayer);e.CloudPlayer=f})(com$adobe$ccv$app||
...
function(a){var b=0,d=this._options.duration,c=(a.match(/m/g)||[]).length,e=(a.match(/s/g)||[]).length,x=(a.match(/h/g)||[]).length,f=(a.match(/[^msh0-9]/g)||[]).length,p=c+e+x,l=0,r=0,v=0;this.isValidOffsetParameter(c,e,x,f)&&(0==p?b=parseInt(a,10):(0!=x&&(a=a.split("h"),l=parseInt(a[0],10),a=a[1]),0!=c&&(c=a.split("m"),r=parseInt(c[0],10),a=c[1]),0!=e&&(e=a.split("s"),v=parseInt(e[0],10),a=e[1])),isFinite(v)&&isFinite(r)&&isFinite(l)&&""==a&&(b=3600*l+60*r+v));b>=Math.floor(d)&&(b=0);return b};
...
function(a,c,e,h,k,m,t){var x=$.Deferred();this._config=c;if(this.isAttachedTo(a,e,h,k,m,t))x.resolve(this);else{var f=this;b.prototype.attachTo.call(this,a,c,e,h,k,m,t).done(function(){f._disableVideoJSUI(a);x.resolve(f)}).fail(function(){x.reject(f)})}return x.promise()};a.prototype._disableVideoJSUI=function(a){a=a.find(".video-js");a.find(".vjs-poster").hide();a.find(".vjs-text-track-display").hide();a.find(".vjs-loading-spinner").hide();a.find(".vjs-big-play-button").hide();a.find(".vjs-control-bar").hide()};
...
m._showPoster())}function k(){var b=m.videoJSPlayer.duration();Infinity===b||x<f?x>=t?(LOGGING&&Log.error(a._LOGTAG,""),h()):(++x,LOGGING&&Log.info(a._LOGTAG,"Waiting for video-js, attempt #"+x+" of "+t),setTimeout(k,100)):(LOGGING&&Log.info(a._LOGTAG,"video-js is ready, duration="+b),h())}var m=this,t=20,x=0,f=1;b.prototype.embedPlayer.call(this,d,c,e);this._registerEvents();k();this.$fullScreenElement&&this.getCoreView().setFullScreenElement(this.$fullScreenElement)};a.prototype._registerEvents=
...
e=$.Deferred();c._greaterOrEqualFileSize(a,d).then(function(f){(f?c.getFileSize(a,d,2*d):c._getFileSize(a,b,d)).then(function(a){e.resolve(a)},function(){e.reject()})},function(){e.reject()});return e.promise()};a._LOGTAG="FileSizeEvaluator";return a}(),d=function(){function b(a){this._http=a}b.prototype._calculateFileSize=function(d,c){var e=$.Deferred(),t=new a(this._http),f=c.videoTrackInfo,u=Math.floor(f.pixelWidth*f.pixelHeight*0.28)*c.duration,f=Math.floor(u-u/2),u=Math.ceil(u+u/2);t.getFileSize(d,
...
d.substring(d.lastIndexOf("/")+1),c.totalFileSize=parseInt(d,10),c.mp4Asset.fileSize=c.totalFileSize;b(a,c.totalFileSize)},function(a){console.error("Request failed:"+a.toString())});return d.promise()};b.prototype.parseSegment=function(a,d,c){var e=this,f=$.Deferred();this.getNextTag(d).then(function(u){e.parseType(u.type,d+8,u.size-8).then(function(p){p?f.resolve(e.mp4Asset):0==c||d+u.size<c?(LOGGING&&Log.info(b._LOGTAG,"Found '"+u.type+"', looking for 'moov'..."),e.parseSegment(a,d+u.size,0<c?
c-u.size:0).then(function(a){f.resolve(a)},function(a){f.reject()})):(LOGGING&&Log.error(b._LOGTAG,"Can't locate 'moov' tag in "+a),f.reject())},function(a){f.reject()})},function(a){f.reject()});return f.promise()};b.prototype.getNextTag=function(a){var b=$.Deferred();this.getData(a,8).then(function(d){var c=new DataView(d.buffer);d=c.getUint32(0);c=c.getType(4);b.resolve({size:d,type:c,offset:a+8})},function(){b.reject()});return b.promise()};b.prototype.getNextTagInDataView=function(a,b){var d=
...
c);this.updateAnalyzeProgress(100);return this.mp4Asset};b.prototype.generateSampleGroupTable=function(a,b){var d=new e.SampleGroupTable,c=a.durationTable.length,f=a.headerInfo.timeScale,g=a.headerInfo.durationInTrackTimeScale/f,p=a.sampleToChunkTable,l=a.chunkTable,r=a.durationTable,v=a.sampleTable,s=a.syncSampleTable,y=a.compositionTimeToSampleTimeTable,q=0,w=0,n;if(void 0!=y)for(q=0;q<y.length;q++)n=v.getSample(q),n.compositionTime=y[q];for(var y=p.size(),D=l.size(),C=0,q=0;q<y;q++){n=p.getSampleToChunk(q);
var B=n.samplesPerChunk;n=n.startChunk;var A;A=q==y-1?D+1:p.getSampleToChunk(q+1).startChunk;for(w=n-1;w<A-1;w++){n=l.getChunk(w);n.startSample=C;n.totalSamples=B;for(var z=n.offset,E=0;E<B;E++)n=v.getSample(C+E),n.offset=z,z+=n.size;C+=B}}l=p=0;if(b)if(void 0!=s)for(n=s.getSyncSample(0)-1,f=s.size(),p=y=0,q=1;q<=f;q++){l=c;q<f&&(l=s.getSyncSample(q)-1);g=new e.SampleGroup(n);for(w=n;w<l;w++)n=v.getSample(w),g.addSample(n.offset,n.size,p,r[y],n.compositionTime),p+=r[y],y++;d.addSampleGroup(g);n=l}else{p=
0;f=Math.floor(g);s=c%f;for(q=0;q<f-1;q++){l=(c-s)/f*q+1;g=new e.SampleGroup(l);for(w=0;w<(c-s)/f;w++)n=v.getSample(l+w),g.addSample(n.offset,n.size,p,r[l+w],n.compositionTime),p+=r[l+w];d.addSampleGroup(g)}l=(c-s)/f*(f-1)+1;g=new e.SampleGroup(l);for(q=l;q<c;q++)n=v.getSample(q),g.addSample(n.offset,n.size,p,r[q],n.compositionTime),p+=r[q];d.addSampleGroup(g)}else{for(q=s=p=0;q<this.mp4Asset.videoTrackInfo.sampleGroupTable.getSampleGroupsCount();q++){n=this.mp4Asset.videoTrackInfo.sampleGroupTable.getSampleGroup(q);
n=n.getSample(n.getSampleCount()-1);w=(n.duration+n.startTime)/this.mp4Asset.videoTrackInfo.timeScale*f;g=new e.SampleGroup(s);for(l=0;p<=w;){n=v.getSample(s+l);if(void 0==n)break;g.addSample(n.offset,n.size,p,r[s+l],n.compositionTime);p+=r[s+l];l++}s+=l;d.addSampleGroup(g)}for(q=s;q<c;q++)n=v.getSample(q),g=d.getSampleGroup(d.getSampleGroupsCount()-1),g.addSample(n.offset,n.size,p,r[q],n.compositionTime),p+=r[q]}return d};b.prototype.updateProcessMoovProgress=function(a){};b.prototype.updateAnalyzeProgress=
function(a){};b.prototype.getData=function(a,b){var d=$.Deferred();this._http.http({method:"GET",url:this.url,headers:{Range:"bytes="+a+"-"+(a+b-1)},responseType:"arraybuffer"}).then(function(a){a=new Uint8Array(a.response);d.resolve(a)},function(){d.reject()});return d.promise()};b._LOGTAG="MP4Parser";return b}(),c=function(){function a(){}a.prototype.parse=function(a,c){var e=new b;return(new d(e)).parse(a,c)};return a}();e.MP4Parser=c})(com$adobe$ccv$mp4||(com$adobe$ccv$mp4={}));
